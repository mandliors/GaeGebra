...
Vector2 vector2_multiply(Vector2 a, double b) { return (Vector2){a.x * b, a.y * b}; }
Vector2 vector2_divide(Vector2 a, double b) { return (Vector2){a.x / b, a.y / b}; }
...
Vector2 vector2_normalize(Vector2 a) { return vector2_divide(a, vector2_length(a)); }
...
Vector2 vector2_reflect(Vector2 a, Vector2 normal) { return vector2_subtract(a, vector2_multiply(normal, 2 * vector2_dot(a, normal))); }